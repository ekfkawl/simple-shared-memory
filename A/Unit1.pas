...
begin
  FMappingHandle:= CreateFileMapping(INVALID_HANDLE_VALUE, nil, PAGE_READWRITE, 0, SHARED_MEM_SIZE, SHARED_MEM_NAME);
  if FMappingHandle = 0 then
    raise Exception.CreateFmt('CreateFileMapping 실패: %d', [GetLastError]);
